...
let numLayers = 7; // Set the number of waves
...
function drawWaveLayer(layerIndex) {
    fill(colors[layerIndex % colors.length]); // Cycle through colors if numLayers > colors.length
    noStroke();
    beginShape();
    let xoff = 0;
    let waveHeight = 50 - layerIndex * 5; // Decrease height for each layer
